...
required_paths = { ...
    fullfile(project_root, '20260120 BiSb', '590 PL2 10w 0.004 10sx300', 'eq3D.mat'), ...
    fullfile(project_root, '20260120 BiSb', 'n0 pl2 10w 0.004 10s x300', 'eq3D.mat'), ...
    fullfile(project_root, '20260120 BiSb', 'no pl2 20w 0.004 10sx300 2film', 'eq3D.mat') ...
    };
