...
%   callbacks but does NOT read or modify application state.
    ...
    bg_method = uidropdown(control_grid, ...
        "Items", {'Power', 'ExpPoly3', 'Pearson', 'PearsonVII', 'Power2', 'Exp2'}, ...
        "Value", 'Power', ...
        "ValueChangedFcn", cb.on_display_change);
    ...
    deconv_method = uidropdown(control_grid, ...
        "Items", {'LucyRichardson', 'FourierLog'}, ...
        "Value", 'LucyRichardson', ...
        "ValueChangedFcn", cb.on_display_change);
    deconv_method.Layout.Row = 6;
    deconv_method.Layout.Column = 6;

    deconv_iter = uieditfield(control_grid, "numeric", ...
        "Value", 5, ...
        "Limits", [1 100], ...
        "ValueDisplayFormat", "%.0f", ...
        "Tooltip", "Lucy-Richardson iterations (ignored for FourierLog)", ...
        "ValueChangedFcn", cb.on_display_change);
    ...
    ui_handles.DeconvMethodDropdown = deconv_method;
