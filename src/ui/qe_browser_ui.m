...
%   callbacks but does NOT read or modify application state.
    ...
    bg_method = uidropdown(control_grid, ...
        "Items", {'Auto', 'Power', 'ExpPoly3', 'Pearson', 'PearsonVII', 'Power2', 'Exp2', 'DualWindow'}, ...
        "Value", 'Auto', ...
        "Tooltip", "DualWindow uses W1 and W2 as side-band anchors; enable Dual to pass W2.", ...
        "ValueChangedFcn", cb.on_display_change);
    ...
    correct_auto_btn = uibutton(control_grid, ...
        "Text", "Correct Auto", ...
        "Tooltip", "After Auto Fit: select a q channel, click this, then click the corrected peak in the single-spectrum panel", ...
