...
comparison = make_qe_struct( ...
    ...
    label=string(qeData.label) + " | comparison off-axis component, center reconstructed from manual symmetric off-axis reference bands, not physical intensity", ...
    view_kind="comparison", ...
    stage_name=string(qeData.stage_name), ...
    note="comparison off-axis component, center reconstructed from manual symmetric off-axis reference bands, not physical intensity");
