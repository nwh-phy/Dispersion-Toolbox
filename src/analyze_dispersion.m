...
sessions = struct( ...
    ...
    'path',  {fullfile(project_dir, '20260120 BiSb', '590 PL2 10w 0.004 10sx300'), ...
              fullfile(project_dir, '20260120 BiSb', 'no pl2 20w 0.004 10sx300 2film')}, ...
    'dq',    {0.005, 0.0025} ...
);
...
fig = figure('Name', 'BiSb Plasmon Dispersion: 10w vs 20w', ...
...
sgtitle(fig, 'BiSb Thin Film Plasmon Dispersion 10w vs 20w Defocus', ...
...
%% ══════════════════════════════════════════════════════════════�?%  Summary table
%  ══════════════════════════════════════════════════════════════�?fprintf('\n════════════════════════════════════════════════════════\n');
fprintf('  SUMMARY: BiSb Plasmon Dispersion Comparison\n');
fprintf('════════════════════════════════════════════════════════\n');
